...
<p>Core : <em>5.3.3</em></p>
<p>ServerSide : <em>5.4.2</em></p>
<p>Consent : <em>5.2.5</em></p>
<p>IAB : <em>5.0.0</em></p>
...
<pre><code>implementation 'com.tagcommander.lib:core:5.3.3'
</code></pre>
...
<p>For example:</p>
<pre><code>implementation 'com.tagcommander.lib:ServerSide:5.4.2'
...
<pre><code>compile (name:'TCCore-release-5.3.3', ext:'aar')
compile (name:'TCServerSide-release-5.4.2', ext:'aar')
compile (name:'TCSegment-release-5.0.0', ext:'aar')
compile (name:'TCConsent-release-5.2.5', ext:'aar')
</code></pre>
