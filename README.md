...
<p>For example:</p>
<pre><code>implementation 'com.tagcommander.lib:ServerSide:5.1.1'
...
compile files('libs/TCServerSide-release-5.1.1.jar')
...
compile (name:'TCServerSide-release-5.1.1', ext:'aar')
