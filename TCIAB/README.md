...
<p>We support IAB 2.2, the following steps are required once you decide to upgrade your TCConsent to a IABv2.2 compatible version, wich is TCConsent:5.3.0+  or higher.</p>
...
<pre><code>TCConsent.getInstance().setLanguage("fr");
